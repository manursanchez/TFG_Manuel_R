...
class ordenTotalV2(MRJob):
 ...
 #===============================REDUCER=======================================     
    ...
    def reducer(self, key, values):
        ...
        # ordenamos la lista 
        listaCompletaRegistros.sort(key = lambda x: float(x[5])) #Usamos la expresión Lambda para vagos ;-) donde le decimos
                                                                # por qué campo tiene que ordenar la lista de listas.
